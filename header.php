...
<head>
    ...
    <meta property="og:image" content="<?php echo $this->fields->Cover ? $this->fields->Cover : $this->options->background ; ?>" />
    ...
    <?php endif; ?>
    <!-- Cloudflare Web Analytics --><script defer src='https://cf-analytics.leohearts.com/cf-bcon.min.js' data-cf-beacon='{"token": "77451a38c1e0446db70a5f594e7c9a64", "send": {"to": "https://cf-analytics.leohearts.com/rum"}}'></script><!-- End Cloudflare Web Analytics -->
</head>
